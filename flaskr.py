...
def before_first_request():
    ...
    # help(get_scheduler().add_job)
    _scheduler = get_scheduler()
    _scheduler.remove_all_jobs()
    # job add
    from app.module.scheduler.new_file import file_create_test
    _scheduler.add_job('create_file_test', file_create_test,  args=(1,2), trigger='cron', second=10)
